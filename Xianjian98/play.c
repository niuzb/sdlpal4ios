...
--*/
{
   ...
   else if (g_InputState.dwKeyPress & kKeySave)
   {
   	extern void PAL_Saveslot();
      //
      // Show the in-game menu
      //
      PAL_Saveslot();
   } else if (g_InputState.dwKeyPress & kKeyStore)
   {
   	extern void PAL_Restoreslot();
      //
      // Show the in-game menu
      //
      PAL_Restoreslot();
   } else if (g_InputState.dwKeyPress & kKeyfullblood)
   {
              //
//       PAL_Restoreslot();
     //  extern void PAL_SetPlayerMaxHP();
       PAL_SetPlayerMaxHP();
